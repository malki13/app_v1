...
//     <Drawer.Screen name="WorkOrders" component={WorkOrdersScreen} options={{ title: 'Órdenes de Trabajo', drawerItemStyle: { display: 'none' } }} />
//     <Drawer.Screen name="WorkOrderDetail" component={WorkOrderDetailScreen} options={{ title: 'Detalle de Orden', drawerItemStyle: { display: 'none' } }} />
//     <Drawer.Screen name="WorkOrderISP" component={WorkOrderISPScreen} />
//   </Drawer.Navigator>
// );
