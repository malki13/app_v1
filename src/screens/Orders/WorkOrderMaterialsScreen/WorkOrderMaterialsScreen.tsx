...
// // Material seleccionado para la orden
...
//     // Lista de materiales seleccionados para la orden
...
//     // Calcula cuánto ya fue agregado de este producto
...
//             Alert.alert('Serie requerida', 'Selecciona un número de serie para este producto.');
//             return;
//         }
//         if (hasSerials && selectedSerial) {
//             // Con serie: siempre cantidad 1 por serie
//             const alreadySerial = materials.find(
//                 m => m.product_id === selectedItem.product_id && m.serial_number === selectedSerial,
//             );
//             if (alreadySerial) {
...
//             }]);
//         } else {
//             // Sin serie: busca si ya existe y suma
...
//                         // await ordersService.addMaterials(orderId, materials);
...
//                         {/* Si tiene series, mostrar selector de serie */}
...
//                                         const alreadyUsed = materials.some(
//                                             m => m.serial_number === s.serial_number,
//                                         );
//                                         return (
//                                             <TouchableOpacity
//                                                 key={idx}
...
//                                         style={styles.qtyBtn}
//                                         onPress={() => {
//                                             const v = Math.max(1, parseInt(quantityInput || '1', 10) - 1);
...
//                                             const v = Math.min(available, parseInt(quantityInput || '1', 10) + 1);
//                                             setQuantityInput(String(v));
//                                         }}
//                                     >
//                                         <Text style={styles.qtyBtnText}>+</Text>
...
//         marginRight: SIZES.sm, borderWidth: 1, borderColor: COLORS.primary + '40', maxWidth: 180,
//     },
...
//     exhaustedText: { fontSize: SIZES.fontSm, color: COLORS.success ?? '#22c55e' },
//     // Confirmar
//     confirmContainer: {
...
//     modalAvailable: {
//         fontSize: SIZES.fontMd, color: COLORS.textSecondary,
//         marginBottom: SIZES.md, paddingBottom: SIZES.sm,
...
//     },
//     qtyBtnText: { fontSize: 24, color: COLORS.white ?? '#fff', fontWeight: TYPOGRAPHY.weightBold },
//     quantityInput: {
